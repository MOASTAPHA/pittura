  ...
  return (
    <div className={isRTL ? 'rtl' : ''}>
      ...
      <div className="relative py-16 md:py-24 bg-museum-sand">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1649159261849-5331f9a7d7af?q=80&w=1772&auto=format&fit=crop')] bg-cover bg-center opacity-10"></div>
